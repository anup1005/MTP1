...
*/
void preflow(int V,int E ,int source, int sink,int *cpu_index,int *cpu_edgeList,int *cpu_edgeLength,
            int *cpu_Rindex,int *cpu_RedgeList,int *cpu_RedgeLength,int *cpu_height, int *cpu_excess_flow,int *Excess_total )
{
   ...
   // cout<<endl;
    for(int i=start;i<=end;i++){
        ...
        change(V,2*E,source,cpu_edgeList[i],cpu_Rindex,cpu_RedgeList,cpu_RedgeLength,0);
        change(V,2*E,cpu_edgeList[i],source,cpu_Rindex,cpu_RedgeList,cpu_RedgeLength,w);
